...
/**
 * Client-side shell for the home page. Receives the initial market dataset
 * pre-fetched on the server (via RSC in `app/page.tsx`), then hands it to
 * <MarketList> which silently refreshes every 60s.
 */
